...
<body>
	...
	<div class="row m-5 p-5">
		<div class="col-4"></div>
		<div class="col-4 m-5 p-5">

			<a href="/addNewSupplier" class="btn btn-warning">Add Supplier</a>&nbsp;&nbsp;&nbsp;
			<a href="/editSupplierDetails" class="btn btn-warning">Update Supplier Details</a>&nbsp;&nbsp;&nbsp; 
			<a href="/deleteSupplier" class="btn btn-warning">Delete Supplier</a>
